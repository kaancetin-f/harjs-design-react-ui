...
const sizes = [
  { name: "xs", height: "1.5rem", padding: "0.5rem", fontSize: "0.75rem" },
  { name: "sm", height: "1.75rem", padding: "0.625rem", fontSize: "0.75rem" },
  { name: "md", height: "2rem", padding: "0.75rem", fontSize: "0.875rem" },
  { name: "lg", height: "2.25rem", padding: "0.875rem", fontSize: "0.875rem" },
  { name: "xl", height: "2.5rem", padding: "1rem", fontSize: "1rem" },
  { name: "2xl", height: "3rem", padding: "1.25rem", fontSize: "1.125rem" },
];
...
let colorOutput = `.har-button {${colors.map(renderColor).join("\n")}}`;
...
let sizeOutput = `.har-button {${sizes
  .map((size) =>
    sizeTemplate
      ...
      .replace(/__PADDING__/g, size.padding)
