...
const Radio = forwardRef<HTMLInputElement, IProps>(({ trace, pastTrace, name, ...props }, ref) => {
  ...
  return (
    <div className="har-radio-wrapper">
      <Checkbox ref={_innerRef} {...props} name={resolvedName} type="radio" border={{ radius: "full" }} />
